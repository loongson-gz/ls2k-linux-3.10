...
#ifdef CONFIG_LOONGSON_CACHEMEM
struct device *get_cachelock_device(void *noused);
#else
#define get_cachelock_device(x) x
#endif
...
int igb_setup_tx_resources(struct igb_ring *tx_ring)
{
	...
	tx_ring->desc = dma_alloc_coherent(get_cachelock_device(dev), tx_ring->size,
...
int igb_setup_rx_resources(struct igb_ring *rx_ring)
{
	...
	rx_ring->desc = dma_alloc_coherent(get_cachelock_device(dev), rx_ring->size,
...
void igb_free_tx_resources(struct igb_ring *tx_ring)
{
	...
	dma_free_coherent(get_cachelock_device(tx_ring->dev), tx_ring->size,
...
void igb_free_rx_resources(struct igb_ring *rx_ring)
{
	...
	dma_free_coherent(get_cachelock_device(rx_ring->dev), rx_ring->size,
