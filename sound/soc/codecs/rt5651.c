...
/******  reg   bit_hi bit_lo  ****/
        {0x63,   0xa810},	//bit 4,11,13,15 first power on
	{0xfa,   0x0011},
	{0x80,   0x5000},
	{0x81,   0x1f02},
	{0x82,   0x0800},
...
/******  reg   bit_hi bit_lo  ****/
	{0x61,   0x9800},	//power I2S1 & DACL1 & DACR1
        {0x2a,   0x1212},	//bit14/6:Mute Control for DACL/R1 to Stereo DAC Left/Right Mixer
        {0x4f,   0x0278},	//bit0:Mute Control for DACL1 to OUTMIXL
        {0x52,   0x0278},	//bit0:Mute Control for DACR1 to OUTMIXR
/*****  jd  *****/
        {0xbc,   0x0200},
        {0xbb,   0x0c08},
        {0x64,   0x0204},
/****hp out****/
        {0x45,   0x4000},	//bit13:Mute Control for HPOVOL to HPOMIX
        {0x02,   0x2020},	//power on with low vol & 
        {0x02,   0x1010},	//power on with low vol & 
/****line out****/
        {0x53,   0xc000},
        {0x03,   0x2020},
        {0x03,   0x1010},
        {0x05,   0x8000},
/**** buf ****/
        {0x62,   0x0800},	//bit11: Stereo1 DAC Digital Filter Power
        {0x63,   0xf8fb},
        {0x65,   0xc000},	//bit14,15	//record:bit10,11
        {0x66,   0x3c00},	//bit10,11:HPOVOLL	//bit12,13:OUTVOLL
        {0x6a,   0x003d},
        {0x6c,   0x3e00},	//bit9,10:DAC clk2,clk1(all need) //bit12:ADC clk
        {0x81,   0x1f02},	//clock: k, n
        {0x82,   0x0800},	//clock: m
        {0x8e,   0x8019},	//hp amp
        {0x8f,   0x3100},	//depop
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		regmap_update_bits(rt5651->regmap, RT5651_PWR_ANLG1,
			RT5651_PWR_FV1 | RT5651_PWR_FV2 | RT5651_PWR_HP_L | RT5651_PWR_HP_R | 0xfbf8 ,
			RT5651_PWR_FV1 | RT5651_PWR_FV2 | RT5651_PWR_HP_L | RT5651_PWR_HP_R | 0xfbf8);
		break;
