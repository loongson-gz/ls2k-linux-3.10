 ...
 * versions.
 */
#define smp_mb__before_atomic_dec()	 __asm__ __volatile__(__WEAK_LLSC_MB : : :"memory")
#define smp_mb__after_atomic_dec()	 __asm__ __volatile__(__WEAK_LLSC_MB : : :"memory")
#define smp_mb__before_atomic_inc()	 __asm__ __volatile__(__WEAK_LLSC_MB : : :"memory")
#define smp_mb__after_atomic_inc()	 __asm__ __volatile__(__WEAK_LLSC_MB : : :"memory")
